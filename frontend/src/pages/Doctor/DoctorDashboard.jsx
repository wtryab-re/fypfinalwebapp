...
const DoctorDashboard = () => {
  ...
  const currentCases = activeTab === "available" ? availableCases 
  ...
  useEffect(() => {
    ...
    } else if (selectedCase && !filteredCases.find(c => c._id === selectedCase._id)) {
  ...
  const totalReviewed = myCases?.filter((c) => c.status === "reviewed")?.length || 0;
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
            {!currentCases.length ? (
              <p className="text-gray-500 text-center py-6">
                {activeTab === "available" ? "No available cases." 
                 : activeTab === "myCases" ? "No assigned cases."
                 : "No rejected cases."}
              </p>
              ...
              filteredCases.map((c) => {
                ...
                return (
                  ...
                  >
                    {/* Priority Badge */}
                    {badge && (
                      <div className={`${badge.color} text-white text-xs font-bold px-2 py-1 rounded text-center`}>
          ...
          {selectedCase ? (
            <>
              <div className="flex justify-between items-start mb-4">
                <div>
                  {priorityBadge && (
                    <div className={`${priorityBadge.color} text-white text-sm font-bold px-3 py-1 rounded mb-2 inline-block`}>
                  ...
                  <p className="text-gray-500 text-sm">
                    Submitted on: {new Date(selectedCase.createdAt).toLocaleString()}
                  </p>
                </div>
                {activeTab === "myCases" && selectedCase.status !== "reviewed" && (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="flex flex-col gap-4">
                  ...
                  {/* AI Analysis Preview */}
                  {selectedCase.aiResult && selectedCase.aiResult.predictions && (
                    <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {selectedCase.aiResult.predictions.slice(0, 3).map((pred, idx) => (
                  ...
                  {selectedCase.status === "reviewed" && selectedCase.report && (
                    <div className="border-t border-gray-200 pt-4">
                      <h3 className="text-gray-800 font-semibold text-lg mb-2">
                        Medical Report Summary
                      </h3>
                      <div className="bg-white border border-gray-200 rounded p-4 space-y-3">
                        {["diagnosis", "findings", "recommendations", "medications", "followUp"].map(
                          (field) =>
